class DynamicGrid {
    ...
    bindEvents() {
        ...
        document.querySelector('.our-clients').addEventListener('mousemove', (e) => {
        ...
        document.querySelector('.our-clients').addEventListener('mouseout', () => {
            this.mouse.x = -1000;
            this.mouse.y = -1000;
        });
    }
    ...
    updateCells() {
        ...
        for (let cell of this.cellPool) {
            ...
            const dy = this.mouse.y - (cell.y + cell.height) + 50;
...
document.addEventListener('DOMContentLoaded', () => {
    const canvas = document.getElementById('gridCanvasClients');
